		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mantenimientousuario-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mantenimientousuario-display": {
								"semanticObject": "mantenimientousuario",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mantenimientousuario",
									"url": sap.ui.require.toUrl("mantenimientousuario")
								}
							}
						}
					}
